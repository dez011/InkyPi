...
class WaveshareDisplay(AbstractDisplay):
    ...
    def initialize_display(self):
        ...
        # Construct module path dynamically - e.g. "kiosk.display.waveshare_epd.epd7in3e"
        module_name = f"kiosk.display.waveshare_epd.{display_type}"
        ...
        panel_resolution = (w, h) if w >= h else (h, w)
